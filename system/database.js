module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Bot WhatsApp free🥰'
      if (!('sk_author' in setting)) setting.sk_author = '© By AnggaKz✅🗿😍'
      ...
      if (!('owners' in setting)) setting.owners = ['6281998425782']
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/f996d4e04e4258bd031b4.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/Ly28IB8Fel4JbPS0qCUy2p'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         pluginDisable: [],
         groupmode: false,
         sk_pack: 'Bot WhatsApp free🥰',
         sk_author: '© By AnggaKz✅🗿😍',
         self: false,
         mimic: [],
         noprefix: false,
         multiprefix: true,
